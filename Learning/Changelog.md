...
- **Outpost seeding.** Outposts are seeded around settlements at world generation, position- and faction-aware (needs a compatibility patch that contributes an outpost creator, e.g. the Outposts Expanded patch).
